...
import VerticalDividerSettings from '@/Components/Editor/VerticalDividerSettings.vue';
...
<template>
    <div class="flex flex-col gap-4">
        ...
        <div v-show="activeTab === 'divider'" class="space-y-4">
            ...
            <!-- Dynamic Vertical Divider Controls -->
            <VerticalDividerSettings 
                v-model:enabled="settings.verticalDivider.enabled"
                v-model:thinColor="settings.verticalDivider.thinColor"
                v-model:thickColor="settings.verticalDivider.thickColor"
                v-model:thinWidth="settings.verticalDivider.thinWidth"
                v-model:thickWidth="settings.verticalDivider.thickWidth"
                v-model:gap="settings.verticalDivider.gap"
            />
        </div>
